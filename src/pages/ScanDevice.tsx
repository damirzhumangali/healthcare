...
const copy = {
  ru: {
    ...
    measurementError: "Не получилось создать измерение. Проверь backend и VITE_API_BASE_URL, затем попробуй ещё раз.",
  },
  kk: {
    kicker: "QR → СТАНЦИЯ",
    ...
    measurementError: "Өлшеуді жасай алмады. Backend пен VITE_API_BASE_URL тексеріп, қайтадан көріңіз.",
  },
  en: {
    kicker: "QR → STATION",
    ...
    measurementError: "Failed to create measurement. Check the backend and VITE_API_BASE_URL, then try again.",
  },
} as const;
