...
const appointmentText = {
  ru: {
    ...
    createError: "Не удалось создать запись. Проверь backend и VITE_API_BASE_URL, затем попробуй ещё раз.",
    creating: "Создаем...",
    submit: "Записаться",
    cancel: "Отмена",
  },
  kk: {
    ...
    createError: "Жазылуды жасау мүмкін болмады. Backend пен VITE_API_BASE_URL тексеріп, қайта көріңіз.",
    creating: "Жасалуда...",
    submit: "Жазылу",
    cancel: "Бас тарту",
  },
  en: {
    ...
    createError: "Could not create the appointment. Check the backend and VITE_API_BASE_URL, then try again.",
    creating: "Creating...",
